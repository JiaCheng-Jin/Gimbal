...
void bmi088_write_reg(uint8_t reg_addr, uint8_t data) {
    bmi088_write_byte(0x7F & reg_addr);
...
void bmi088_accel_write_single_reg(uint8_t reg_addr, uint8_t data) {
    ...
    bmi088_write_reg(reg_addr, data);
